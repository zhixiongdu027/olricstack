...
type Config struct {
	...
	// DurableHook is called only from owner-side DMap business paths. It is not
	// called for backup apply, read-repair, migration, eviction, or raw storage
	// operations.
	DurableHook DurableHook
